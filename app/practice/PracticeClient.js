...
━━━━━━━━━━━━━━━━━━━━━━━━━━ */
const BUILTIN_VOCAB = [
  { id: "b01", term: "apple",       kind: "words", data: { zh: "苹果",       example_en: "She ate an apple for breakfast every morning.",              example_zh: "她每天早上吃一个苹果当早餐。" } },
  { id: "b02", term: "book",        kind: "words", data: { zh: "书",         example_en: "He read a book before going to sleep.",                      example_zh: "他睡前读了一本书。" } },
  { id: "b03", term: "cat",         kind: "words", data: { zh: "猫",         example_en: "The cat jumped onto the warm window sill.",                   example_zh: "那只猫跳上了温暖的窗台。" } },
  { id: "b04", term: "dog",         kind: "words", data: { zh: "狗",         example_en: "The dog wagged its tail when it saw me.",                     example_zh: "那只狗看到我时摇起了尾巴。" } },
  { id: "b05", term: "eat",         kind: "words", data: { zh: "吃",         example_en: "We like to eat together as a family.",                        example_zh: "我们喜欢一家人坐在一起吃饭。" } },
  { id: "b06", term: "friend",      kind: "words", data: { zh: "朋友",       example_en: "She is my best friend from middle school.",                   example_zh: "她是我初中时最好的朋友。" } },
  { id: "b07", term: "happy",       kind: "words", data: { zh: "开心的",     example_en: "I feel happy when the sun is shining.",                       example_zh: "阳光明媚的时候我感到很开心。" } },
  { id: "b08", term: "house",       kind: "words", data: { zh: "房子",       example_en: "They built a new house near the river.",                      example_zh: "他们在河边建了一栋新房子。" } },
  { id: "b09", term: "idea",        kind: "words", data: { zh: "想法",       example_en: "That is a really great idea for the project.",                example_zh: "这个项目的想法真的很棒。" } },
  { id: "b10", term: "job",         kind: "words", data: { zh: "工作",       example_en: "He found a good job after months of searching.",              example_zh: "他找了好几个月终于找到了一份好工作。" } },
  { id: "b11", term: "keep",        kind: "words", data: { zh: "保持",       example_en: "You should keep trying even when things are hard.",           example_zh: "即使事情很难，你也应该坚持尝试。" } },
  { id: "b12", term: "learn",       kind: "words", data: { zh: "学习",       example_en: "Children learn best when they are having fun.",               example_zh: "孩子们在玩乐中学习效果最好。" } },
  { id: "b13", term: "money",       kind: "words", data: { zh: "钱",         example_en: "She saved her money to buy a new phone.",                     example_zh: "她存钱买了一部新手机。" } },
  { id: "b14", term: "night",       kind: "words", data: { zh: "夜晚",       example_en: "The stars looked beautiful on a clear night.",                example_zh: "晴朗的夜晚星星看起来格外美丽。" } },
  { id: "b15", term: "open",        kind: "words", data: { zh: "打开",       example_en: "Please open the window to let in some fresh air.",            example_zh: "请打开窗户让新鲜空气进来。" } },
  { id: "b16", term: "people",      kind: "words", data: { zh: "人们",       example_en: "Many people gathered in the square to celebrate.",            example_zh: "很多人聚集在广场上庆祝。" } },
  { id: "b17", term: "quiet",       kind: "words", data: { zh: "安静的",     example_en: "The library must stay quiet so everyone can focus.",          example_zh: "图书馆必须保持安静，这样大家才能专心。" } },
  { id: "b18", term: "run",         kind: "words", data: { zh: "跑",         example_en: "She likes to run in the park every morning.",                 example_zh: "她喜欢每天早上在公园里跑步。" } },
  { id: "b19", term: "sleep",       kind: "words", data: { zh: "睡觉",       example_en: "You need to sleep at least eight hours a night.",             example_zh: "你每晚至少需要睡八个小时。" } },
  { id: "b20", term: "talk",        kind: "words", data: { zh: "说话",       example_en: "They talk on the phone every single day.",                    example_zh: "他们每天都会通电话。" } },
  { id: "b21", term: "understand",  kind: "words", data: { zh: "理解",       example_en: "I did not understand the question at first.",                 example_zh: "我一开始没有理解这个问题。" } },
  { id: "b22", term: "visit",       kind: "words", data: { zh: "拜访",       example_en: "We plan to visit my grandparents this weekend.",              example_zh: "我们计划这个周末去看望我的祖父母。" } },
  { id: "b23", term: "water",       kind: "words", data: { zh: "水",         example_en: "Drink enough water to stay healthy every day.",               example_zh: "每天喝足够的水才能保持健康。" } },
  { id: "b24", term: "example",     kind: "words", data: { zh: "例子",       example_en: "Can you give me an example of what you mean?",               example_zh: "你能给我举个例子说明你的意思吗？" } },
  { id: "b25", term: "young",       kind: "words", data: { zh: "年轻的",     example_en: "She looks very young for her age.",                           example_zh: "她看起来比实际年龄年轻得多。" } },
  { id: "b26", term: "beautiful",   kind: "words", data: { zh: "漂亮的",     example_en: "The sunset over the ocean was truly beautiful.",              example_zh: "海洋上的日落真的非常美丽。" } },
  { id: "b27", term: "change",      kind: "words", data: { zh: "改变",       example_en: "Small habits can change your life over time.",                example_zh: "小习惯久而久之可以改变你的生活。" } },
  { id: "b28", term: "decide",      kind: "words", data: { zh: "决定",       example_en: "It was hard to decide which path to take.",                   example_zh: "很难决定走哪条路。" } },
  { id: "b29", term: "enjoy",       kind: "words", data: { zh: "享受",       example_en: "I really enjoy listening to music while cooking.",            example_zh: "我非常享受边做饭边听音乐的感觉。" } },
  { id: "b30", term: "forget",      kind: "words", data: { zh: "忘记",       example_en: "Do not forget to call your mom today.",                       example_zh: "今天不要忘记给你妈妈打电话。" } },
  { id: "b31", term: "give",        kind: "words", data: { zh: "给",         example_en: "She decided to give her old books to the school.",            example_zh: "她决定把旧书捐给学校。" } },
  { id: "b32", term: "help",        kind: "words", data: { zh: "帮助",       example_en: "He always helps his neighbors when they need it.",            example_zh: "他总是在邻居需要的时候伸出援手。" } },
  { id: "b33", term: "important",   kind: "words", data: { zh: "重要的",     example_en: "It is important to be honest with the people you love.",      example_zh: "对你爱的人诚实是非常重要的。" } },
  { id: "b34", term: "jump",        kind: "words", data: { zh: "跳",         example_en: "The kids love to jump on the trampoline outside.",            example_zh: "孩子们喜欢在室外的蹦床上跳。" } },
  { id: "b35", term: "kind",        kind: "words", data: { zh: "友善的",     example_en: "Being kind to others costs you nothing at all.",              example_zh: "对他人友善一点代价都没有。" } },
  { id: "b36", term: "listen",      kind: "words", data: { zh: "听",         example_en: "Please listen carefully before you answer the question.",     example_zh: "请仔细听完再回答问题。" } },
  { id: "b37", term: "move",        kind: "words", data: { zh: "移动",       example_en: "They decided to move to a bigger city last year.",            example_zh: "他们去年决定搬到一个更大的城市。" } },
  { id: "b38", term: "need",        kind: "words", data: { zh: "需要",       example_en: "We need more time to finish the report properly.",            example_zh: "我们需要更多时间才能好好完成这份报告。" } },
  { id: "b39", term: "offer",       kind: "words", data: { zh: "提供",       example_en: "He was kind enough to offer his seat on the bus.",            example_zh: "他很好心地在公共汽车上让座。" } },
  { id: "b40", term: "promise",     kind: "words", data: { zh: "承诺",       example_en: "She made a promise to never give up on her dream.",           example_zh: "她承诺永远不会放弃自己的梦想。" } },
  { id: "b41", term: "question",    kind: "words", data: { zh: "问题",       example_en: "Raise your hand if you have a question for the teacher.",     example_zh: "如果你有问题想问老师，请举手。" } },
  { id: "b42", term: "remember",    kind: "words", data: { zh: "记得",       example_en: "I still remember the first day I started this job.",          example_zh: "我还记得我开始这份工作的第一天。" } },
  { id: "b43", term: "share",       kind: "words", data: { zh: "分享",       example_en: "They share everything with each other as good friends.",      example_zh: "作为好朋友，他们彼此分享一切。" } },
  { id: "b44", term: "think",       kind: "words", data: { zh: "思考",       example_en: "Take a moment to think before you make a decision.",          example_zh: "做决定之前先花点时间思考一下。" } },
  { id: "b45", term: "use",         kind: "words", data: { zh: "使用",       example_en: "You can use this app to track your daily habits.",            example_zh: "你可以用这个应用来追踪每天的习惯。" } },
  { id: "b46", term: "voice",       kind: "words", data: { zh: "声音",       example_en: "Her voice was calm and steady during the presentation.",      example_zh: "她在演讲时声音平静而稳定。" } },
  { id: "b47", term: "wait",        kind: "words", data: { zh: "等待",       example_en: "We had to wait for over an hour at the airport.",             example_zh: "我们在机场等了一个多小时。" } },
  { id: "b48", term: "experience",  kind: "words", data: { zh: "经历",       example_en: "Traveling alone was the best experience of my life.",         example_zh: "独自旅行是我人生中最美好的经历。" } },
  { id: "b49", term: "yesterday",   kind: "words", data: { zh: "昨天",       example_en: "I finished reading that novel yesterday afternoon.",          example_zh: "我昨天下午读完了那本小说。" } },
  { id: "b50", term: "zero",        kind: "words", data: { zh: "零",         example_en: "The temperature dropped to zero degrees overnight.",          example_zh: "气温一夜之间降到了零度。" } },
];
